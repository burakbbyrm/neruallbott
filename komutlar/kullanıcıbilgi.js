...
exports.run = async (client, message, args) => {// can ♡ b#1308
  ...
  .addField('Kullanıcı İsmi', message.member.nickname ? message.member.nickname : 'Bulunamadı!', true)
  .addField('Hesap Oluşturulma Tarihi', created.format('dddd, MMMM Do YYYY, @ h:mm:ss a'))
  .addField('Sunucuya Katılma Tarihi', joined.format('dddd, MMMM Do YYYY, @ h:mm:ss a'))
  .addField('Roller '+`[${roles.size}]`, member_roles);
